...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      traveler_coupons: {
        Row: {
          ...
          redeemed_channel: Database["public"]["Enums"]["traveler_coupon_channel"] | null;
    ...
    Enums: {
      ...
      media_review_state: "unreviewed" | "ai_suggested" | "approved" | "needs_revision";
      ...
      ownership_transfer_status: "pending" | "accepted" | "rejected" | "cancelled" | "expired";
      ...
      travel_plan_status: "draft" | "active" | "shared_with_concierge" | "archived";
