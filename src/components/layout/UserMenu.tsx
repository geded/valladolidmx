...
export function UserMenu() {
  ...
  if (loading) {
    return (
      <span
        className="inline-flex min-h-11 items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-[13px] text-muted-foreground"
        aria-busy="true"
      >
    ...
    return (
      <div className="relative z-[60]">
        <button
          ...
          className="inline-flex min-h-11 items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-[13px] font-medium transition-all hover:bg-accent active:scale-[0.98]"
  ...
  return (
    <Link
      to="/auth"
      className="inline-flex min-h-11 items-center gap-2 rounded-full bg-primary px-4 py-1.5 text-[13px] font-medium text-primary-foreground shadow-sm transition-all hover:opacity-90 active:scale-[0.98]"
      title={t("nav.sign_in")}
    >
      <UserRound className="size-4" aria-hidden />
