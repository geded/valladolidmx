...
export function ConsejoAluxSection({ config }: { config?: Record<string, unknown> } = {}) {
  ...
  return (
    <section id="consejo-alux" className="@container bg-secondary/40 py-20 @3xl:py-24">
      <Container>
        <div
          data-home-layout="consejo-alux"
          className="mx-auto flex max-w-3xl flex-col items-start gap-6 rounded-3xl border border-border bg-card p-8 shadow-sm @3xl:flex-row @3xl:items-center @3xl:p-10"
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-balance text-xl leading-snug @3xl:text-2xl">
              {t("sections.alux_body")}
            </p>
            <p className="mt-4 text-xs text-muted-foreground">
              Toca el botón de Alux en cualquier destino, empresa o producto para recibir
