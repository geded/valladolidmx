...
function buildDTO(
  ...
  const capabilities = {
    ...
    showRating: cfg.capabilities.showRating ?? true,
    showDistance: cfg.capabilities.showDistance ?? true,
    showAvailability: cfg.capabilities.showAvailability ?? true,
    showFavorite: cfg.capabilities.showFavorite ?? true,
    showSecondaryAction: cfg.capabilities.showSecondaryAction ?? true,
    showTerritorialContext: cfg.capabilities.showTerritorialContext ?? true,
    showInstitutionalBadges: cfg.capabilities.showInstitutionalBadges ?? true,
    showHighlights: cfg.capabilities.showHighlights ?? true,
  };
  return {
    variant: cfg.variant,
