...
export function CategoriaCard({ category }: { category: Category }) {
  ...
  return (
    ...
    <div
      className="relative min-w-0 [&_a]:min-h-[44px] [&_a]:min-w-[44px] [&_a]:focus-visible:outline-none [&_a]:focus-visible:ring-2 [&_a]:focus-visible:ring-ring [&_button]:min-h-[44px] [&_button]:min-w-[44px]"
