    ...
    <main className="mx-auto flex max-w-6xl flex-col gap-14 px-4 py-10">
      <header className="flex flex-col gap-2">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          Bloque oficial de listado de productos. Reutilizable en business, destination, region,
          category, landing, micrositios y futuras Experience Pages. Contrato preparado para
          incorporar Alux, Discovery Navigator y Context Engine sin romper compatibilidad.
        </p>
      </header>
