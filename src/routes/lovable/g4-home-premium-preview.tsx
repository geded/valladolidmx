...
const ROUTES = [
  {
    id: "d3dcdaf6-87ec-4c44-9154-ace7d799fa90",
    title: "Cenotes y jaguares",
    duration: "3 días",
    stops: 4,
    vibe: "Naturaleza, arqueología y gastronomía",
    description:
      "Tres días entre Valladolid y Ek Balam: cenotes ocultos, mercado local y la acrópolis al amanecer.",
    sequence: ["Cenote Zací", "Comida en Yerbabuena del Sisal", "Cenote Suytun", "Ek Balam"],
    media: MEDIA.centro,
    href: "/rutas/valladolid-ek-balam",
  },
  {
    id: "96893479-7cc5-4694-8b3a-9b61c79c81ef",
    title: "Costa rosada",
    duration: "2 días",
    stops: 2,
    vibe: "Naturaleza y fotografía",
    description:
      "Río Lagartos y Las Coloradas: flamencos, salineras rosadas y atardeceres frente al Golfo.",
    sequence: ["Río Lagartos", "Las Coloradas"],
    media: MEDIA.cenote,
    href: "/rutas/costa-rosada",
  },
  {
    id: "fc65c005-9b7c-418a-a2e1-73131b875ec3",
    title: "Pueblos coloniales",
    duration: "4 días",
    stops: 5,
    vibe: "Cultura, arquitectura y artesanía",
    description: "Valladolid, Uayma e Izamal: arquitectura, conventos y talleres artesanos.",
    sequence: [
      "Calzada de los Frailes",
      "Ex Convento de San Bernardino",
      "Uayma",
      "Restaurante Kinich",
      "Villa Amarilla · Izamal",
    ],
    media: MEDIA.calle,
    href: "/rutas/pueblos-coloniales",
  },
] as const;
