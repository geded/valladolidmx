/**
 * /cuenta/mi-viaje — Panel del Turista bajo WorkspaceShell (cuenta).
 *
 * Reconciliación 3: la ruta huérfana /mi-viaje se migra al workspace
 * "cuenta". El contenido (Perfil Inteligente + Arma tu Viaje + mis
 * casos) es idéntico al anterior /mi-viaje; sólo cambia el layout
 * que ahora vive dentro del Workspace Engine v2.0.
 */
