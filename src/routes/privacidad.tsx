  ...
  return (
    ...
    >
      <article className="prose prose-neutral max-w-3xl dark:prose-invert">
        <h2>1. Responsable</h2>
        <p>
          Valladolid.mx — operado en Valladolid, Yucatán, México — es el responsable del tratamiento
          de tus datos personales recabados a través de <strong>quehacerenvalladolid.com</strong> y
          dominios asociados.
        </p>
        ...
        <ul>
          <li>
            Nombre, correo electrónico y foto de perfil al iniciar sesión (incluyendo Google
            Sign-In).
          </li>
          ...
          <li>
            Ubicación aproximada, sólo si otorgas permiso, para mostrar distancias y recomendaciones
            cercanas.
          </li>
        </ul>
        ...
        <p>
          Cuando inicias sesión con Google recibimos únicamente tu nombre, correo electrónico y foto
          de perfil. No accedemos a tus contactos, correos, calendario ni archivos. Puedes revocar
        ...
        <p>
          No vendemos tus datos. Los compartimos únicamente con: (a) empresas locales cuando
          reservas o solicitas un servicio; (b) proveedores tecnológicos que operan la plataforma
          bajo contrato de confidencialidad; (c) autoridades cuando la ley lo requiera.
        </p>
        ...
        <h2>7. Seguridad</h2>
        <p>
          Aplicamos medidas técnicas y administrativas razonables (cifrado en tránsito, control de
          accesos, RLS en base de datos) para proteger tu información.
        </p>

        <h2>8. Cambios</h2>
        <p>
          Publicaremos cualquier cambio a este aviso en esta misma página con la fecha de
