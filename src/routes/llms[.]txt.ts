...
const PAGES: Entry[] = [
  { label: "Inicio", path: "/", description: "Puerta de entrada al Oriente Maya de Yucatán." },
  {
    label: "Oriente Maya",
    path: "/oriente-maya",
    description: "Región turística — destinos, pueblos y cenotes del oriente de Yucatán.",
  },
  {
    label: "Experiencias",
    path: "/experiencias",
    description: "Tours, cenotes, ruinas y experiencias auténticas.",
  },
  {
    label: "Hoteles",
    path: "/hoteles",
    description: "Hospedaje boutique, haciendas y hoteles familiares.",
  },
  {
    label: "Restaurantes",
    path: "/restaurantes",
    description: "Cocina yucateca, mercados y gastronomía maya.",
  },
  { label: "Eventos", path: "/eventos", description: "Agenda cultural, festivales y ferias." },
  {
    ...
    description: "Rentas vacacionales en Valladolid y alrededores.",
  },
  { label: "Promociones", path: "/promociones", description: "Ofertas vigentes verificadas." },
  {
    label: "Arma tu viaje",
    path: "/arma-tu-viaje",
    description: "Planea con Alux, copiloto turístico.",
  },
...
const DESTINATIONS: Entry[] = [
  {
    label: "Valladolid",
    path: "/oriente-maya/valladolid",
    description: "Pueblo Mágico colonial, puerta del Oriente Maya.",
  },
  {
    label: "Ek Balam",
    path: "/oriente-maya/ek-balam",
    description: "Zona arqueológica maya del jaguar negro, con cenote Xcanché.",
  },
  {
    label: "Izamal",
    path: "/oriente-maya/izamal",
    description: "Pueblo Mágico amarillo, convento franciscano y pirámide Kinich Kakmó.",
  },
  {
    label: "Espita",
    path: "/oriente-maya/espita",
    description: "Pueblo Mágico, comunidad artesana del oriente yucateco.",
  },
  {
    label: "Uayma",
    path: "/oriente-maya/uayma",
    description: "Templo colonial policromado único en Yucatán.",
  },
  {
    label: "Río Lagartos",
    path: "/oriente-maya/rio-lagartos",
    description: "Reserva de la Biosfera, manglares y flamencos rosados.",
  },
  {
    label: "Las Coloradas",
    path: "/oriente-maya/las-coloradas",
    description: "Salineras rosadas frente al Golfo de México.",
  },
];

function renderEntries(entries: Entry[]): string {
  return entries.map((e) => `- [${e.label}](${absoluteUrl(e.path)}): ${e.description}`).join("\n");
}
