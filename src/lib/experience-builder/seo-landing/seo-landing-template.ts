...
export const SEO_LANDING_SLOTS: readonly SeoLandingSlotDefinition[] = [
  {
    id: "hero",
    order: 1,
    blockType: "vmx.experience.hero",
    blockVersion: "1.0.0",
    variant: "immersive",
    label: "Portada inmersiva",
    omitWhenEmpty: false,
  },
  {
    id: "subnav",
    order: 2,
    blockType: "vmx.experience.subnav",
    blockVersion: "1.0.0",
    variant: "pill",
    label: "Navegación interna",
    omitWhenEmpty: true,
  },
  {
    id: "badges",
    order: 3,
    blockType: "vmx.experience.institutional-badges",
    blockVersion: "1.0.0",
    variant: null,
    label: "Distintivos institucionales",
    omitWhenEmpty: true,
  },
  {
    id: "intro",
    order: 4,
    blockType: "vmx.experience.section",
    blockVersion: "1.0.0",
    variant: "editorial",
    label: "Por qué visitar",
    omitWhenEmpty: true,
  },
  {
    id: "features",
    order: 5,
    blockType: "vmx.experience.features",
    blockVersion: "1.0.0",
    variant: "grid",
    label: "Lo que distingue",
    omitWhenEmpty: true,
  },
  {
    id: "story",
  ...
  },
  {
    ...
    blockVersion: "1.0.0",
    variant: "editorial",
    label: "Sección práctica",
    omitWhenEmpty: true,
  },
  {
    id: "gallery",
    order: 9,
    blockType: "vmx.experience.gallery",
    blockVersion: "1.0.0",
    variant: "mosaic",
    label: "Galería",
    omitWhenEmpty: true,
  },
  {
    id: "offers",
    order: 10,
    blockType: "vmx.experience.products",
    blockVersion: "1.0.0",
    variant: "grid",
  ...
  },
  {
    id: "infoGrid",
    order: 11,
    blockType: "vmx.experience.info-grid",
    blockVersion: "1.0.0",
    variant: "cards",
  ...
  },
  {
    ...
    blockVersion: "1.0.0",
    variant: "quote",
    label: "Cita acreditada",
    omitWhenEmpty: true,
  },
  {
    id: "map",
    order: 13,
    blockType: "vmx.experience.map",
    blockVersion: "1.0.0",
    variant: "single",
    label: "Ubicación",
    omitWhenEmpty: true,
  },
  {
    id: "related",
    order: 14,
    blockType: "vmx.experience.related-collection",
    blockVersion: "1.0.0",
    variant: "grid",
    label: "Sigue descubriendo",
    omitWhenEmpty: true,
  },
  {
    id: "reviews",
    order: 15,
    blockType: "vmx.experience.reviews",
    blockVersion: "1.0.0",
    variant: "list",
    label: "Reseñas",
    omitWhenEmpty: true,
