...
export const EDITORIAL_BUILDER_POLICY: EditorialBuilderPolicy = {
  ...
  blocks: [
    ...
    {
      // G8-D · Plantilla compuesta exclusiva de la superficie `home`.
      type: "vmx.home.premium-g4",
      mode: "authorable",
      family: "home",
      variants: ["premium-g4-approved"],
      ...
      fields: [
        ...
        {
          field: "hero_cta_secondary_label",
          class: "editorial",
          type: "text",
          max_length: 400,
          translatable: true,
        ...
        {
          field: "experiencias_description",
          class: "editorial",
          type: "text",
          max_length: 400,
          translatable: true,
        ...
        {
          field: "travel_plan_cta_add_label",
          class: "editorial",
          type: "text",
          max_length: 400,
          translatable: true,
        ...
        {
          field: "travel_plan_cta_added_label",
          class: "editorial",
          type: "text",
          max_length: 400,
          translatable: true,
        ...
        {
          field: "travel_plan_cta_alux_label",
          class: "editorial",
          type: "text",
          max_length: 400,
          translatable: true,
        ...
        {
          field: "eventos_media_url",
          class: "media",
          type: "media",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "categorias_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "destinos_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "rutas_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "experiencias_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "servicios_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "eventos_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "que_hacer_max_items",
          class: "editorial",
          type: "number",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "categorias_items",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        ...
        {
          field: "experiencias_items",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "servicios_stays",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "servicios_food",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        ...
        {
          field: "show_experiencias",
          class: "editorial",
          type: "boolean",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "show_servicios",
          class: "editorial",
          type: "boolean",
          writable_by: ["founder_admin", "territorial_editor"],
        },
    ...
    },
    {
      ...
      mode: "authorable",
      family: "destination",
      variants: ["destino-premium-g4-approved"],
      allowed_sources: ["routing.canonical", "media.registry"],
      ...
      fields: [
        ...
        {
          field: "galeria_layout",
          class: "editorial",
          type: "select",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "destination_slug",
          class: "reference",
          type: "text",
          max_length: 200,
          writable_by: ["founder_admin", "territorial_editor"],
        ...
        {
          field: "hero_supporting",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "servicios_items",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "descubre_paragraphs",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
        {
          field: "descubre_media",
          class: "editorial",
          type: "reference",
          writable_by: ["founder_admin", "territorial_editor"],
        },
    ...
    {
      // G8-E · Plantilla compuesta de los 6 listados turísticos G5.
      type: "vmx.listing.premium-g5",
      mode: "authorable",
      family: "listing",
      variants: ["listado-premium-g5-approved"],
      allowed_sources: ["routing.canonical", "media.registry"],
      surfaces: ["landing", "destination"],
      authoring_roles: ["founder_admin", "territorial_editor"],
      fields: [
        {
          field: "variant",
