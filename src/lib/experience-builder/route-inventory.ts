...
const OVERRIDES: Readonly<Record<string, Override>> = {
  ...
  "src/routes/lugares.tsx": {
    businessPriority: "high",
    maturity: "L3",
    migrationStatus: "planned",
  },
  "src/routes/lugares.index.tsx": {
    businessPriority: "high",
    maturity: "L3",
    migrationStatus: "planned",
    dependencies: ["points_of_interest", "listing-public-contract"],
    notes:
      "G4-PLACES · Listado regional de Lugares y sitios de interés (contrato público v1.1.0, lecturas reales).",
  },
  "src/routes/oriente-maya/$destino.lugares.index.tsx": {
    ...
    dependencies: ["points_of_interest", "listing-public-contract"],
    notes:
      "G4-PLACES · Listado contextual de Lugares dentro del destino (contexto bloqueado, cercanos separados).",
  },
  ...
  "src/routes/_authenticated/cms/rutas.index.tsx": {
    category: "cms",
    businessPriority: "high",
    maturity: "L3",
    migrationStatus: "not-applicable",
    notes: "Lote 3C — listado CMS de Rutas/Itinerarios.",
  },
  "src/routes/_authenticated/cms/rutas.nueva.tsx": {
    category: "cms",
    businessPriority: "medium",
    maturity: "L3",
    migrationStatus: "not-applicable",
    notes: "Lote 3C — alta de Ruta/Itinerario.",
  },
  "src/routes/_authenticated/cms/rutas.$id.editar.tsx": {
    category: "cms",
    businessPriority: "high",
    maturity: "L3",
    migrationStatus: "not-applicable",
    notes: "Lote 3C — edición de Ruta/Itinerario y paradas.",
  },
...
export const SCANNED_ROUTE_FILES: readonly string[] = [
  ...
  "src/routes/lovable/g4-event-listing-premium-preview.tsx",
  "src/routes/lovable/g4-event-profile-premium-preview.tsx",
  "src/routes/lovable/g4-place-listing-premium-preview.tsx",
  "src/routes/lovable/g4-place-premium-preview.tsx",
  "src/routes/lovable/g4-vacation-rental-listing-premium-preview.tsx",
  ...
  "src/routes/lovable/g8-r1f1c-business-generic-preview.tsx",
  "src/routes/lovable/g8-r1f1c-product-generic-preview.tsx",
  ...
  "src/routes/lovable/territorial-listing-premium-preview.tsx",
  ...
  "src/routes/preview/f1k-destinations.tsx",
