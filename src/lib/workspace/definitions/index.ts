...
const founder: WorkspaceDefinition = {
  ...
  commands: [
    ...
    {
      id: "founder.cmd.empresas",
      label: "Ver empresas",
      icon: Building2,
      group: "ver",
      run: (ctx) => ctx.navigate("/admin/empresas"),
    },
    {
      id: "founder.cmd.concierge",
      label: "Ver Concierge",
      icon: ConciergeBell,
      group: "ver",
      run: (ctx) => ctx.navigate("/admin/concierge"),
    },
    {
      id: "founder.cmd.users",
      label: "Usuarios y roles",
      icon: Users,
      group: "config",
      run: (ctx) => ctx.navigate("/admin/sistema/usuarios"),
    },
    {
      id: "founder.cmd.system",
      label: "Sistema",
      icon: Settings,
      group: "config",
      run: (ctx) => ctx.navigate("/admin/sistema"),
    },
    {
      id: "founder.cmd.cms",
      label: "Ir al CMS",
      icon: FileCog,
      group: "ir",
      run: (ctx) => ctx.setWorkspace("cms"),
    },
    {
      id: "founder.cmd.public-site",
...
const portal: WorkspaceDefinition = {
  ...
  navigation: [
    ...
    {
      id: "portal.ventas-ordenes",
      workspaceId: "portal",
      label: "Mis ventas (órdenes)",
      icon: ShoppingBag,
    ...
    {
      id: "portal.visibilidad",
      workspaceId: "portal",
      label: "Paquetes de visibilidad",
      icon: Sparkles,
    ...
    {
      id: "portal.invitaciones",
      workspaceId: "portal",
      label: "Invitaciones",
      icon: Mail,
      to: "/portal/invitaciones",
      group: "equipo",
      order: 10,
      surfaces: ["sidebar", "palette"],
    },
  ...
  commands: [
    {
      id: "portal.cmd.new-product",
      label: "Crear producto nuevo",
      icon: Plus,
      group: "crear",
      hint: "Añadir servicio, tour o ítem al catálogo",
      run: (ctx) => ctx.navigate("/portal/catalogo"),
    },
    {
      id: "portal.cmd.upload-photos",
      label: "Subir fotos a la galería",
      icon: ImageIcon,
      group: "crear",
      run: (ctx) => ctx.navigate("/portal/galeria"),
    },
    {
      id: "portal.cmd.edit-ficha",
      label: "Editar ficha pública",
      icon: BookOpenText,
      group: "crear",
      run: (ctx) => ctx.navigate("/portal/ficha"),
    },
    {
      id: "portal.cmd.invite",
      label: "Invitar a un colaborador",
      icon: Mail,
      group: "equipo",
      run: (ctx) => ctx.navigate("/portal/invitaciones"),
    },
    {
      id: "portal.cmd.reviews",
      label: "Ver reseñas recientes",
      icon: Bell,
      group: "ver",
      run: (ctx) => ctx.navigate("/portal/actividad"),
    },
    {
      id: "portal.cmd.plans",
      label: "Planes y visibilidad",
      icon: CreditCard,
      group: "ver",
      run: (ctx) => ctx.navigate("/portal/pagos"),
    },
    {
      id: "portal.cmd.public-site",
      label: "Abrir sitio público",
      icon: ExternalLink,
      group: "ir",
      hint: "Ver la plataforma como visitante",
      run: (ctx) => ctx.navigate("/"),
    },
    {
      id: "portal.cmd.alux",
      label: "Preguntar a Alux",
      icon: Sparkles,
      group: "ir",
      run: (ctx) => ctx.navigate("/alux"),
    },
  ],
  context: {
    workspaceId: "portal",
...
const concierge: WorkspaceDefinition = {
  ...
  alux: {
    ...
    summary: "Pulso de expedientes: priorización por SLA, casos sin asignar y carga personal.",
    suggestedActions: () => [
      {
        id: "respond-oldest",
  ...
  commands: [
    {
      id: "concierge.cmd.inbox",
      label: "Ir a la bandeja",
      icon: Inbox,
      run: (ctx) => ctx.navigate("/concierge"),
    },
    {
      id: "concierge.cmd.public-site",
      label: "Abrir sitio público",
      icon: ExternalLink,
      run: (ctx) => ctx.navigate("/"),
    },
    {
      id: "concierge.cmd.alux",
      label: "Preguntar a Alux",
      icon: Sparkles,
      run: (ctx) => ctx.navigate("/alux"),
    },
...
const cms: WorkspaceDefinition = {
  ...
  navigation: [
    ...
    {
      id: "cms.ventas-en-linea",
      workspaceId: "cms",
      label: "Ventas en línea",
      icon: CreditCard,
      to: "/cms/ventas-en-linea",
      group: "operacion",
      order: 10.05,
      surfaces: ["sidebar", "palette"],
    },
    ...
    {
      id: "cms.visibilidad.solicitudes",
      workspaceId: "cms",
      label: "Solicitudes de visibilidad",
      icon: Bell,
      to: "/cms/visibilidad/solicitudes",
      group: "operacion",
      order: 10.2,
      surfaces: ["sidebar", "palette"],
    },
    {
      id: "cms.visibilidad.spotlight",
      workspaceId: "cms",
      label: "Founder Spotlight",
      icon: Sparkles,
      to: "/cms/visibilidad/spotlight",
      group: "operacion",
      order: 10.3,
      surfaces: ["sidebar", "palette"],
    },
    {
      id: "cms.observabilidad",
      workspaceId: "cms",
      label: "Observabilidad",
      icon: LineChart,
      to: "/cms/observabilidad",
      group: "operacion",
      order: 11,
      surfaces: ["sidebar", "palette"],
    },
  ...
  commands: [
    {
      ...
      icon: Plus,
      group: "crear",
      run: (ctx) => ctx.navigate("/cms/experience-builder"),
    },
    {
      id: "cms.cmd.new-business",
      label: "Nueva empresa",
      icon: Building2,
      group: "crear",
      run: (ctx) => ctx.navigate("/cms/empresas"),
    },
    {
      id: "cms.cmd.new-product",
      label: "Nuevo producto",
      icon: Package,
      group: "crear",
      run: (ctx) => ctx.navigate("/cms/productos"),
    },
    {
      id: "cms.cmd.moderate",
      ...
      icon: Bell,
      group: "operar",
      run: (ctx) => ctx.navigate("/cms/reviews"),
    },
    {
      id: "cms.cmd.media",
      ...
      icon: ImageIcon,
      group: "operar",
      run: (ctx) => ctx.navigate("/cms/media"),
    },
    {
      id: "cms.cmd.observability",
      label: "Ver observabilidad",
      icon: LineChart,
      group: "operar",
      run: (ctx) => ctx.navigate("/cms/observabilidad"),
    },
    {
      id: "cms.cmd.public-site",
      label: "Abrir sitio público",
      icon: ExternalLink,
      group: "ir",
      run: (ctx) => ctx.navigate("/"),
  ...
  commands: [
    {
      ...
      icon: Compass,
      group: "viaje",
      run: (ctx) => ctx.navigate("/cuenta/mi-viaje"),
    },
    {
      id: "cuenta.cmd.favorites",
      label: "Ver favoritos",
      icon: HeartHandshake,
      group: "viaje",
      run: (ctx) => ctx.navigate("/cuenta/favoritos"),
    },
    {
      id: "cuenta.cmd.cart",
      label: "Ver carrito",
      icon: ShoppingCart,
      group: "viaje",
      run: (ctx) => ctx.navigate("/cuenta/carrito"),
    },
    {
      id: "cuenta.cmd.concierge",
      label: "Contactar Concierge",
      icon: ConciergeBell,
      group: "viaje",
      run: (ctx) => ctx.navigate("/cuenta/concierge"),
    },
    {
      id: "cuenta.cmd.explore",
      label: "Explorar destinos",
      icon: Search,
      group: "descubrir",
      run: (ctx) => ctx.navigate("/oriente-maya"),
    },
    {
      id: "cuenta.cmd.alux",
      label: "Preguntar a Alux",
    ...
    {
      id: "cuenta.cmd.host",
      label: "Convertirme en anfitrión",
      icon: Building2,
      group: "cuenta",
      run: (ctx) => ctx.navigate("/cuenta/anfitrion"),
    },
    {
      id: "cuenta.cmd.profile",
      label: "Editar mi perfil",
      icon: UserRound,
      group: "cuenta",
      run: (ctx) => ctx.navigate("/cuenta/perfil"),
    },
    {
      id: "cuenta.cmd.public-site",
