...
export const PROFILE_CATALOG: Readonly<Record<TravelerProfileId, ProfileDefinition>> = {
  ...
  couple_national: {
    ...
    propensities: {
      ...
      favorite_to_plan: 0.5,
      concierge_acceptance: 0.45,
  ...
  retirees: {
    ...
    propensities: {
      ...
      favorite_to_plan: 0.6,
      concierge_acceptance: 0.75,
      purchase_intent: 0.7,
      weather_sensitivity: 0.75,
      language_diversity: 0.6,
  ...
  cultural: {
    ...
    propensities: {
      exploration_depth: 0.85,
      favorite_to_plan: 0.6,
      concierge_acceptance: 0.5,
      purchase_intent: 0.55,
      weather_sensitivity: 0.5,
      language_diversity: 0.7,
  ...
  day_tripper: {
    ...
    propensities: {
      exploration_depth: 0.35,
      favorite_to_plan: 0.2,
      concierge_acceptance: 0.15,
