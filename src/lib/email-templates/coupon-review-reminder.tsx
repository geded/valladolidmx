...
const CouponReviewReminderEmail = ({
  ...
  const heading = isSecond ? "¿Nos regalas un minuto?" : "¿Cómo estuvo tu experiencia?";
    ...
    <Html lang="es" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={footer}>
            Tu reseña aparecerá con el sello <strong>Canje verificado</strong>, un distintivo de
            confianza para futuros viajeros.
          </Text>
          {isSecond ? (
