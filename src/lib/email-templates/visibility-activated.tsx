  ...
  return (
    ...
    >
      <Text style={bodyText}>
        ...
        activamos <strong>{planName}</strong> para <strong>{businessName}</strong>. Desde ahora tu
        negocio aparece con mayor prioridad en Valladolid.mx y en las recomendaciones de Alux.
      </Text>
      {expiryLabel ? (
      ...
      <Text style={bodyText}>
        Aprovecha para subir fotos nuevas, publicar promociones y mantener tu ficha actualizada. Los
        primeros días son los de mayor tráfico.
      </Text>
    </VisibilityShell>
  );
};
