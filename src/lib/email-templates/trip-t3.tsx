...
const Email = ({
  ...
  >
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
      ...
      {startDateLabel ? ` comienza el ${startDateLabel}` : ""}. Todo está confirmado y tu concierge
      ya coordinó los detalles con los anfitriones locales.
    </Text>
    ...
    <Text style={{ fontSize: 14, color: "#4a3a2e", lineHeight: 1.7, margin: "0 0 14px" }}>
      • Guarda el folio {folio} — es tu llave al Oriente Maya.
      <br />
      • Descarga tu itinerario para consultarlo sin conexión.
      <br />
      • Empaca ligero, ropa fresca y calzado cómodo para caminar el centro histórico.
      <br />• Alux te acompañará en tiempo real durante todo el viaje.
    </Text>
  </VisibilityShell>
);
