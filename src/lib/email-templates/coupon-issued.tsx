    ...
    <Html lang="es" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            {travelerName ? `Hola ${travelerName}, ` : "Hola, "}gracias por ser un Viajero
            Verificado del Oriente Maya. Aquí está tu cupón digital:
          </Text>
          <Section style={couponBox}>
            <Text style={couponTitle}>{title}</Text>
            {businessName ? <Text style={couponBiz}>en {businessName}</Text> : null}
            {discountPercent ? <Text style={couponDiscount}>-{discountPercent}%</Text> : null}
          ...
          <Text style={text}>
            Presenta este código o el QR desde tu cuenta al llegar al negocio. Es personal e
            intransferible.
          </Text>
          {terms ? (
            <Text style={footer}>
          ...
          <Text style={footer}>¿No solicitaste este cupón? Puedes ignorar este correo.</Text>
        </Container>
      </Body>
    </Html>
  );
