...
const Email = ({
  ...
  >
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
      Esperamos que tu paso por <strong>{destinationName}</strong> te haya dejado recuerdos que
      quieras contar. Cada viajero deja huella en nuestros anfitriones locales, y tu experiencia
      ayuda a que otros descubran este rincón de Yucatán.
    </Text>
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
      Si te animas, comparte una reseña de los lugares que más te gustaron. Cuando regreses, Alux
      recordará tu viaje y te propondrá nuevas rutas.
    </Text>
  </VisibilityShell>
);
