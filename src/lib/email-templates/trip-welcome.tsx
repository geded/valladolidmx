...
const Email = ({
  ...
  >
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
      Hoy comienza tu viaje por <strong>{destinationName}</strong>. Respira profundo: el Oriente
      Maya te recibe con calidez colonial, historia viva y la hospitalidad de sus anfitriones.
    </Text>
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
      Tu concierge y Alux están contigo durante toda la jornada. Escríbeles cuando necesites una
      recomendación, cambiar un plan o descubrir algo nuevo.
    </Text>
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
