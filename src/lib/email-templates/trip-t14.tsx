...
const Email = ({
  ...
  >
    ...
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
      En los próximos días tu concierge y Alux te compartirán recomendaciones para cada etapa:
      reservaciones en restaurantes locales, experiencias culturales y consejos para vivir el
      Oriente Maya con calma.
    </Text>
    <Text style={{ fontSize: 15, color: "#4a3a2e", lineHeight: 1.6, margin: "0 0 14px" }}>
