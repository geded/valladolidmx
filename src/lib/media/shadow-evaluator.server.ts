...
function emitShadowDecisionEvent(
  ...
  const event = {
    ...
    sign_source: decision.signSource ?? null,
    sign_cache_lookup_ms: decision.signCacheLookupMs ?? null,
    sign_network_ms: decision.signNetworkMs ?? null,
    phase_auth_ms: decision.phaseTiming?.authMs ?? null,
    phase_preflight_ms: decision.phaseTiming?.preflightMs ?? null,
    phase_select_ms: decision.phaseTiming?.selectMs ?? null,
    phase_sign_ms: decision.phaseTiming?.signMs ?? null,
    phase_parity_ms: decision.phaseTiming?.parityMs ?? null,
    phase_total_ms: decision.phaseTiming?.totalMs ?? null,
