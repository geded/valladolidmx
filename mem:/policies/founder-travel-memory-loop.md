---
name: Founder Travel Memory Loop Principle
...
- La siguiente etapa NO se entiende como "Post-Trip" aislado, sino como continuidad del ciclo — la memoria del viaje es el punto de partida del siguiente.
- Consistente con Travel Plan Contract v1.0, Founder Continuity Principle (CV6.8) y No AI Memory Duplication Principle.

Why: unificar el ciclo de vida completo del viajero sobre una única entidad canónica, evitando fragmentación funcional y garantizando continuidad narrativa entre viajes.
