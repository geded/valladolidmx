...
BEGIN
  ...
  INSERT INTO public.user_roles (user_id, role_id, role, scope_type, scope_id, created_by)
  VALUES (_target_user_id, _role_id, 'traveler', 'custom_role', _role_id, v_actor)
