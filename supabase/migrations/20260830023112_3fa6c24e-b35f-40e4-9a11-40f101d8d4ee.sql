...
COMMENT ON FUNCTION public.search_marketplace(text,text,text,numeric,numeric,int,int) IS
  'G8-R1-F1I-R1 - Busqueda publica del marketplace. Solo empresas con revision de fuente aprobada (source_review_state = approved), alineada con la autoridad unica de elegibilidad publica.';