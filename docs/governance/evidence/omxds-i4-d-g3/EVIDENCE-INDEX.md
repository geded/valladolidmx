...
| `objective-2026-08-22-h03h04/RUN.json` + `canvas-exact-widths.json` + capturas | Viewports exactos 1024 y 1440: overflowX 0, header sticky tras scroll, 0 errores | H03, H04 (objetiva) |
...
| `objective-2026-08-22/objective.json` | Reflow 320 px y equivalente de zoom 200 % sin overflow | Apoyo H05 (no suficiente) |
...
- **PASS humano:** H01, H02, H08.
- **PASS objetiva:** H03, H04, H06, H09, H10.
