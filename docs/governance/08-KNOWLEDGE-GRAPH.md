...
| `06-BLUEPRINT-MASTER-INDEX.md` v0.6 | Approved | Accountability documental por dominio. |
| `ADR-GOV-0001` | Approved | Taxonomía de 14 dominios. |
| `07-BLUEPRINT-DEPENDENCY-MAP.md` v0.5 | Approved | Nodos técnicos y 1,119 relaciones verificadas. |
...
## 4. Proyección canónica v0.5

| Métrica | Total |
|---|---:|
| Conceptos del Glosario | 56 |
| Dominios canónicos | 14 |
| Nodos heredados de `07` | 988 |
| Nodos totales | 1061 |
| Relaciones heredadas de `07` | 1119 |
| Relaciones de accountability documental | 442 |
| Relaciones totales | 1631 |
...
| Mapa de dependencias aprobado | Cumplido | `07` v0.5 Approved bajo Founder Directive 442 (deriva de `06 v0.6`). |
