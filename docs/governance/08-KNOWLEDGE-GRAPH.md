...
| `06-BLUEPRINT-MASTER-INDEX.md` v0.7 | Approved | Accountability documental por dominio. |
| `ADR-GOV-0001` | Approved | Taxonomía de 14 dominios. |
| `07-BLUEPRINT-DEPENDENCY-MAP.md` v0.6 | Approved | 990 nodos técnicos y 1,119 relaciones verificadas. |
...
## 4. Proyección canónica v0.6

| Métrica | Total |
|---|---:|
| Conceptos del Glosario | 56 |
| Dominios canónicos | 14 |
| Nodos heredados de `07` | 990 |
| Nodos totales | 1063 |
| Relaciones heredadas de `07` | 1119 |
| Relaciones de accountability documental | 444 |
| Relaciones totales | 1633 |
...
| Mapa de dependencias aprobado | Cumplido | `07` v0.6 Approved (deriva de `06 v0.7` e incorpora los dos documentos Commerce sin inferir implementación). |
