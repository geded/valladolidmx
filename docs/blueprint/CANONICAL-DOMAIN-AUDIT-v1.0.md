...
- No existe la noción de "aliases legados" en el código: `orientemaya.com` **no aparece** en ninguna parte del código, por lo que ya podría hacerse 301 a nivel DNS/hosting sin conflicto — pero eso mismo demuestra que el modelo actual no distingue _canónico_ de _alias_ en la capa de aplicación.
...
_Auditoría técnica emitida en modo lectura. Ningún archivo del proyecto fue modificado. Ningún PR abierto. Ninguna recomendación de implementación incluida._
_Autor: Auditoría Independiente · Capítulo 1 · Canonical Domain Architecture Audit v1.0._
