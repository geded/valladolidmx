# SEO.A3.M2 · Zazil Tunich — Content Intelligence v1.0

**Estado:** Investigación editorial completada · Insumo para la primera versión editorial.
**Alcance:** Sólo investigación, análisis y estrategia. La implementación se cierra en `SEO.A3.M2-ZAZIL-TUNICH-FIRST-EDITORIAL-DRAFT-COMPLETION-REPORT-v1.0.md`.
**Regla vinculante:** ningún dato operativo (horarios, precios, capacidad, aforo, políticas, reconocimientos) se publica como hecho sin fuente pública confirmada o autorización explícita del Founder.
...
Referencias: Cenote Suytun, Ik Kil, Río Secreto, Xenotes.

- **Storytelling territorial**: los operadores premium articulan el cenote como puerta a una cosmovisión, no como pileta natural.
- **Información práctica visible arriba**: ubicación + cómo llegar + qué llevar es un patrón universal de conversión.
- **Galería narrativa** (no catálogo de fotos): 6–10 imágenes con jerarquía editorial superan al muro de miniaturas.
- **FAQ enfocadas en objeciones reales** (¿puedo nadar?, ¿es apto para niños?, ¿cuánto dura?, ¿cuánto se camina?).
- **CTA oficial + prueba social**: reservar directo y reseñas verificadas siempre coexisten en la mitad superior.
- **Combinación con arqueológicos** (Chichén Itzá, Ek' Balam) es un patrón recurrente y una oportunidad de interlinking para Valladolid.mx.

No se copia contenido. Sólo se toman patrones estructurales.

## 5. Vacíos y oportunidades para Valladolid.mx

- El sitio oficial es transaccional; **no explica bien qué distingue a Zazil Tunich frente a otros cenotes** ni cómo integrarlo a un itinerario. Aquí Valladolid.mx aporta valor editorial.
- No hay guía comparativa contextual entre cenotes del Oriente Maya. Ruta de interlinking clara hacia `/oriente-maya/valladolid/cenotes`.
- FAQ prácticas están dispersas. Consolidarlas dentro de la landing evita fricción.
- Zazil Tunich se lee mejor combinado con Chichén Itzá, Ek' Balam y Valladolid centro. Interlinking obligatorio.
...
- **Keyword principal**: `Zazil Tunich`.
- **Clusters secundarios**: cenote en Valladolid · cenote museo · cenotes cerca de Valladolid · cenotes cerca de Chichén Itzá · Xibalbá · inframundo maya · experiencias culturales en Valladolid · cena romántica en cenote.
- **Title**: `Zazil Tunich · Cenote Museo del Xibalbá en Valladolid — Valladolid.mx`.
- **Meta description**: descriptiva, 150–160 caracteres, cita "recorrido de 200 metros a 20 metros bajo tierra en el Oriente Maya".
- **H1 único**: nombre + calificador (`Zazil Tunich · Cenote Museo del Xibalbá`).
- **H2**: Por qué visitar · Historia · El Cenote Museo Vivo · El recorrido por Xibalbá · Experiencias · Información práctica · Planea tu visita · Preguntas frecuentes · Sigue descubriendo.
- **Canonical**: `https://www.quehacerenvalladolid.com/oriente-maya/valladolid/cenotes/zazil-tunich` (self-referencial).
- **BreadcrumbList JSON-LD**: Inicio → Oriente Maya → Valladolid → Cenotes → Zazil Tunich.
- **LocalBusiness JSON-LD**: ya emitido por la ruta paramétrica (`localBusinessJsonLd`); no duplicar.
- **OG/Twitter**: derivar `og:image` del `cover_url` del negocio (ya lo hace la ruta).

## 8. Estrategia de interlinking

- Hacia arriba: `/oriente-maya/valladolid/cenotes`, `/oriente-maya/valladolid`, `/oriente-maya`.
- Lateral: otras experiencias culturales de Valladolid, Chichén Itzá, Ek' Balam.
- Hacia abajo: productos del propio negocio ya cargados en `products` (recorrido, nado, cena romántica, ceremonia maya).
- `Related Collection` con `entityKind = business` para cenotes hermanos publicados en el mismo destino (ya lo hace `getBusinessRelated`).

## 9. Prevención de canibalización con zaziltunich.com

- No se copian párrafos completos del sitio oficial.
- Title, H1 y meta distintos.
- Canonical permanece en Valladolid.mx.
- Los CTA externos se etiquetan como **"Reservar en el sitio oficial"** y llevan a `https://zaziltunich.com` (o a la URL específica del producto ya cargada en `products.buy_url`).
...
## 11. Estado editorial de la primera versión

- **verified**: nombre, categoría, ubicación general, distancias declaradas por el operador, existencia del recorrido, existencia de experiencias del catálogo, existencia de Tripadvisor con puntuación agregada, condición de Valladolid como Pueblo Mágico.
- **founder_review_required**: reconocimientos citados (premios), aforos exactos, cifras específicas de la estalactita "más grande", precios finales.
- **placeholder**: horarios, políticas de reserva/cancelación, accesibilidad, idiomas de guía, imágenes.

La landing puede publicarse hoy con contenido verified + framings prudentes; todo lo `founder_review_required` se muestra como afirmación matizada ("según el operador") o se omite hasta validación.

---

**Fin del documento SEO.A3.M2 · Content Intelligence v1.0**
