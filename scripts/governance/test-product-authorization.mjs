...
assert.match(
  authorizeChanges(
    [{ operation: "create", path: "src/components/cards/Example.tsx" }],
    approved,
    "test/authorized",
  ).errors[0],
  /UNAUTHORIZED create/,
...
assert.match(
  authorizeChanges(
    [{ operation: "create", path: "src/routes/invented.tsx" }],
    approved,
    "test/authorized",
  ).errors[0],
  /UNAUTHORIZED create/,
...
assert.match(
  authorizeChanges(
    [{ operation: "delete", path: "src/routes/example.tsx" }],
    approved,
    "test/authorized",
  ).errors[0],
  /UNAUTHORIZED delete/,
...
assert.match(
  authorizeChanges(
    [{ operation: "rename", path: "src/lib/old.ts", to: "src/lib/other.ts" }],
    approved,
    "test/authorized",
  ).errors[0],
  /UNAUTHORIZED rename/,
